    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 mystic-gradient flex-col items-center justify-center p-12 relative">
        ...
        <div className="relative text-center text-white space-y-4">
          ...
          <p className="text-mystic-200 text-lg max-w-xs">Desperte sua intuição. Aprenda Tarot com os melhores instrutores.</p>
        ...
        <div className="w-full max-w-sm space-y-7">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              Novo por aqui?{' '}
              <Link href="/register" className="text-mystic-600 font-medium hover:underline">Criar conta grátis</Link>
            </p>
          </div>
