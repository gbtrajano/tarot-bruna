      ...
      <AreaChart data={data} margin={{ top: 5, right: 5, left: 0, bottom: 0 }}>
        <defs>
          <linearGradient id="rg" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor="#8b4040" stopOpacity={0.3} />
            <stop offset="95%" stopColor="#8b4040" stopOpacity={0} />
          </linearGradient>
        </defs>
        ...
        <Area type="monotone" dataKey="revenue" stroke="#8b4040" strokeWidth={2} fill="url(#rg)" dot={false} activeDot={{ r: 4 }} />
      </AreaChart>
    </ResponsiveContainer>
  )
}
